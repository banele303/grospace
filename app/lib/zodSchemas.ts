...
export const createProductSchema = z.object({
  ...
  minOrderQuantity: z.coerce.number().min(1).optional().nullable(),
  maxOrderQuantity: z.coerce.number().optional().nullable(),
...
export const productSchema = z.object({
  ...
  // Fields from form that were missing in schema
  seasonality: z.string().optional().nullable(),
  unit: z.string().optional().nullable(),
  minOrderQuantity: z.coerce.number().min(1).optional().nullable(),
  maxOrderQuantity: z.coerce.number().optional().nullable(),
